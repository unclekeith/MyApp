...
class ProfileScreen(MDScreen):
    ...
    teaching_subject = ObjectProperty()
    teacher_id_number = ObjectProperty()
    teacher_gender = ObjectProperty()
    teacher_current_academic_level = ObjectProperty()
    teacher_next_of_kin = ObjectProperty()
    ...
    def check_for_updates(self, dt):
        ...
        if current_user_data != self.previous_user_data:
            ...
            self.previous_user_data = (
                current_user_data  # Update the previous data reference
            )
        else:
    ...
    def update_user_data(self):
        ...
        if self.user:
            try:
                ...
                self.number_of_passed_subjects = self.user.get(
